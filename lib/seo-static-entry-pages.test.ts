...
describe('static SEO entry pages', () => {
  it('defines route-level canonical tags for static entry pages and keeps the live blog index crawlable', () => {
    ...
    expect(readEntry('blog/index.html')).toContain('<meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1" />');
    expect(readEntry('en/blog/index.html')).toContain('<link rel="canonical" href="https://www.askqualy.com/en/blog/" />');
    expect(readEntry('en/blog/index.html')).toContain('<meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1" />');
