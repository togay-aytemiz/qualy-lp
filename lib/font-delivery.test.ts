...
describe('font delivery', () => {
  it('removes render-blocking Google Fonts dependencies from all static entries', () => {
    const staticEntries = [
      ...
      'kvkk/index.html',
      'en/kvkk/index.html',
      'pre-information/index.html',
      'en/pre-information/index.html',
      'distance-sales-agreement/index.html',
      'en/distance-sales-agreement/index.html',
      'cancellation-refund/index.html',
      'en/cancellation-refund/index.html',
      'subscription-trial/index.html',
      'en/subscription-trial/index.html',
      '404.html',
    ];
